...
class File:  # Not inheriting from models.Model since we're using raw SQL
    def __init__(self, user_id, full_name, email, phone, age, experience_level, city, state, country, skills, education, interests):
